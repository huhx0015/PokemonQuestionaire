package com.huhx0015.pokemonquestionaire.constants;
...
public class PokemonConstants {
    ...
    public static final int QUIZ_COUNTDOWN_TIME_LIMIT = 30000;
    public static final int QUIZ_COUNTDOWN_TIME_INTERVAL = 1000;
}
